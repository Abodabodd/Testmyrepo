...
// ================== Extractor ==================
class ArabSeedExtractor : VidhideExtractor() {
    // نخلي الدومين الأساسي بدون subdomain حتى يشمل m. / w. / أي subdomain ثاني
    override var mainUrl = "https://gamehub.cam"
}
...
class ArabSeed : MainAPI() {
    ...
    override val supportedTypes =
        setOf(TvType.TvSeries, TvType.Movie, TvType.Cartoon, TvType.Anime)
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        ...
        val items =
            doc.select("ul.blocks__ul.d__flex.boxes__wrap.flex__wrap.row__gap__20 > li").mapNotNull {
                it.toSearchResponse()
            }
    ...
    override suspend fun search(query: String): List<SearchResponse> {
        ...
        return doc.select("ul.blocks__ul.d__flex.boxes__wrap.flex__wrap.row__gap__20 > li")
    ...
    override suspend fun load(url: String): LoadResponse {
        ...
        val detectedTvType =
            if (title.contains("مسلسل", true)) TvType.TvSeries else TvType.Movie
    ...
    override suspend fun loadLinks(
        ...
        val watchLinks = doc.select("a.watch__btn")

        watchLinks.forEach { btn ->
